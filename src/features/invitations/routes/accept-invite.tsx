        ...
        <CardFooter className="flex justify-center pb-8">
          ...
          >
            <Link to={config.linkTo}>
              {config.buttonIcon && (
                <config.buttonIcon className="mr-2 h-4 w-4" />
              )}
              {config.buttonText}
            </Link>
          </Button>
  ...
  switch (status) {
    case 'SUCCESS':
      return {
        ...
        description:
          'Invitation accepted successfully. You can now upload receipts.',
        icon: CheckCircle2,
    ...
    default:
      return {
        ...
        description:
          'We encountered an error processing your invitation. Please try again later.',
        icon: AlertCircle,
