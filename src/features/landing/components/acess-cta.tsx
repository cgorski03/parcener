          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
              <p>
                ...
                to automatically join the waitlist.
              </p>
              ...
              <div className="flex items-center justify-center gap-2 text-sm bg-primary/5 border border-primary/10 rounded-full px-4 py-2 w-fit mx-auto text-primary/80">
                ...
                <span>
                  Know someone already using Parcener? Ask them for an invite
                  link.
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center pt-2">
            ...
            >
              <Button
                variant="outline"
                size="lg"
                className="h-12 px-8 rounded-full text-base font-medium border-2 bg-transparent hover:bg-muted w-full"
              >
