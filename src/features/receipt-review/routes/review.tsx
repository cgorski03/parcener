...
import type { ReceiptProcessingResponse, ReceiptProcessingFailedResponse } from '../server/responses'

type ReceiptResponse = ReceiptProcessingResponse | ReceiptProcessingFailedResponse | ReceiptWithRoom
...
export function ReceiptReviewPage({ receipt, isFetching }: ReceiptReviewPageProps) {
