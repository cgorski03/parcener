...
export function SettlementView({
    ...
    const hasDiscrepancy = moneyValuesEqual(room.receipt.grandTotal, calculatedTotal);
    ...
    return (
        ...
        >
            ...
            {hasDiscrepancy && (
                <SettlementWarning discrepancy={room.receipt.grandTotal - calculatedTotal} className="mb-4" />
            )}
