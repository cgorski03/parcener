import type { FullRoomInfoDto, JoinRoomRequest, PaymentMethodDto } from '@/shared/dto/types'
import { DefinedUseQueryResult, useMutation, useQuery, useQueryClient, UseQueryResult } from '@tanstack/react-query'
import { useRouter } from '@tanstack/react-router'
import { createRoomRpc, getRoomPulseRpc, joinRoomRpc, updateRoomHostPaymentMethod } from '../server/room-rpc';
