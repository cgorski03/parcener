            ...
            <main className="relative z-10 pt-20 pb-24">
                ...
                <div className="max-w-7xl mx-auto px-6 text-center space-y-8 mb-24">
                    <div className="space-y-6">
                        <Badge variant="secondary" className="px-3 py-1 rounded-full text-xs font-medium border border-primary/10 bg-primary/5 text-primary">
                        ...
                        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-light">
                            The open source, collaborative, receipt splitter.
                            Scan a receipt, tap your items, and settle up. <br className="hidden md:block" />
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-6">
                            ...
                            <a href="https://github.com/cgorski03/parcener" target="_blank" rel="noreferrer">
                                <Button variant="ghost" size="lg" className="h-12 px-8 text-base rounded-full hover:bg-muted/50">
                ...
                <div className="max-w-2xl mx-auto px-6 mb-32 text-center py-24 border-y border-border/40 bg-background">
                    <div className="inline-block relative">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed">
                            "A joint heir; a person who holds property equally with another."
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="border bg-card rounded-xl p-8 flex flex-col justify-between h-full min-h-[400px]">
                            <div className="space-y-4">
                                ...
                                <h3 className="text-xl font-bold tracking-tight">Precision OCR</h3>
                                <p className="text-muted-foreground text-sm leading-relaxed">
                                    AI extracts line items, prices, and quantities. You get a dedicated review screen to fix errors or add tip before the room opens.
                                </p>
                            </div>
                            ...
                            <div className="mt-8 pt-6 border-t border-dashed">
                                <div className="space-y-2 opacity-90 pointer-events-none select-none">
                                    <BaseReceiptItemCard
                                        item={{ receiptItemId: 'demo', quantity: 2, interpretedText: "Old Fashioned", price: 28.00, rawText: "2 OLD FASH" }}
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-2 border bg-card rounded-xl p-8 flex flex-col md:flex-row gap-8 overflow-hidden">
                            <div className="flex-1 space-y-4">
                                ...
                                <h3 className="text-xl font-bold tracking-tight">Real-time Sync</h3>
                                <p className="text-muted-foreground text-sm leading-relaxed">
                                    See exactly who claims what as it happens, without refreshing.
                                    Perfect for spotty restaurant Wi-Fi.
                                </p>
                            </div>
                        ...
                        <div className="md:col-span-2 border bg-card rounded-xl p-8 flex flex-col md:flex-row gap-8">
                            ...
                            <div className="flex-1 space-y-4 order-1 md:order-2">
                                ...
                                <h3 className="text-xl font-bold tracking-tight">Fair Settlement</h3>
                                <p className="text-muted-foreground text-sm leading-relaxed">
                                    Tax and tip are distributed proportionally based on the subtotal of items claimed.
                                    We handle the math so you don't have to argue about who owes the extra $2.
                                </p>
                            </div>
                        </div>
            ...
            <footer className="py-12 border-t border-border/40 bg-background">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        <a href="https://github.com/cgorski03/parcener" className="text-muted-foreground hover:text-foreground transition-colors">
