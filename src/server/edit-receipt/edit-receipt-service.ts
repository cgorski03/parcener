...
export async function createReceiptItem(db: DbType, item: ReceiptItemDto, receiptId: string) {
...
export async function finalizeReceiptTotals(db: DbType, receiptTotals: ReceiptTotalsDto): Promise<FinalizeReceiptResponse> {
