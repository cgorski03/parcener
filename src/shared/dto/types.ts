...
export type CreateReceiptItemDto = z.infer<typeof schema.createReceiptItemSchema>
export type SaveReceiptItemDto = z.infer<typeof schema.receiptItemWithReceiptIdSchema>
...
// PaymentMethodType
export type CreatePaymentMethodRequest = z.infer<typeof schema.createPaymentMethodRequest>
...
export type PaymentMethodPayToDto = z.infer<typeof schema.paymentMethodToPaySchema>
